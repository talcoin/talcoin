...
uint256 hashGenesisBlock("0x2576de5cbb2d55a25bf96fa96c41adf6ef03c5c6657c2fd3feb1ab231dc40512");
...
const string strMessageMagic = "TalCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // TalCoin: 1 days
static const int64 nTargetSpacing = 120; // TalCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal talcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TalCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x631adce79177657fc3283bee0c1a8420d170a5c7cb9dadd7fb311c9c17d83aad");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Vrijdagmorgen 09-06-2017 / 10:35:00 bij sTN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1497595321; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2686576;

        if (fTestNet)
        {
            block.nTime    = 1497595321;
            block.nNonce   = 451748;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7d817c7e285f6b294aa586cab27e315f41a7f76401c03c323f9d2742d132c21a"));
